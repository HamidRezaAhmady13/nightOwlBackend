...
//   const url = "https://hamidreza-ahmadi.sbs/about";
...
//       canonical: url,
//     },
//     metadataBase: new URL("https://hamidreza-ahmadi.sbs"),
//   };
// }
...
//         <h2 className="u-text-3xl u-text-secondary u-border-b pb-xs">
//           The Journey
//         </h2>
...
//         <blockquote className="border-l-4  border-amber-600  dark:border-cobalt-600 pl-md italic  ">
//           <p className="text-lg font-serif">مطرب مهتاب رو، آنچه شنیدی بگو</p>
//           <p className="text-sm mt-2">
//             “O moon-faced minstrel, tell what you have heard.”
//           </p>
...
//           <p className="text-sm mt-2">
//             “We are all confidants — tell what you have seen.”{" "}
//           </p>
//         </blockquote>
//       </div>
//     </div>
